...
CompanionCare ("the Company") may obtain information about you from a consumer reporting agency for employment and eligibility-to-serve purposes. Thus, you may be the subject of a "consumer report" and/or an "investigative consumer report" which may include information about your character, general reputation, personal characteristics, and/or mode of living, and which can involve personal interviews with sources such as your neighbors, friends, or associates. These reports may contain information regarding your criminal history, social security verification, motor vehicle records, verification of your education or employment history, or other background checks.

You have the right, upon written request made within a reasonable time, to request whether a consumer report has been run about you, and disclosure of the nature and scope of any investigative consumer report and to request a copy of your report. Please be advised that the nature and scope of the most common form of investigative consumer report obtained with regard to applicants for employment is an investigation into your education and/or employment history conducted by CompanionCare's chosen background check vendor or another outside organization.

The scope of this notice and authorization is all-encompassing, allowing CompanionCare to obtain from any outside organization all manner of consumer reports and investigative consumer reports now and, if you are engaged, throughout the course of your engagement to the extent permitted by law.`;
...
You have the right, upon request, to receive from CompanionCare a written summary of the nature and scope of the background check to be performed. If you would like to receive this summary, please contact CompanionCare.`;

const STATE_MA = `MASSACHUSETTS APPLICANT NOTICE

Massachusetts law affords you the right to know that CompanionCare may request a CORI (Criminal Offender Record Information) report about you. If a CORI report is obtained, you will receive a copy before any decision is made based upon it. You may request a copy of CompanionCare's CORI policy at any time.`;

const STATE_NJ = `NEW JERSEY APPLICANT NOTICE (Opportunity to Compete Act)

Under New Jersey law, CompanionCare will not inquire about your criminal record during the initial application process. If a background check is later obtained and reveals a criminal record, you will have the opportunity to review and respond to that information before any final decision is made.`;
